...
Directional, not a promise of dates. Vote and shape it in
[Discussions](https://github.com/cognis-digital/syntheon/discussions).

## Now (shipping)
- ✅ Curated substrate: 50+ shadcn primitives, blocks, marketing site, dashboard shell
- ✅ 22 typed integration adapters (Stripe/Link, Calendly, Clerk, Claude, Persona, n8n, …)
...
## Next
- **Recorded demo** — an asciinema cast + short video of `studio` → generated app
...
## Non-goals
- No cloud lock-in, no telemetry-by-default, no account requirement
- No cloning of specific brands' proprietary designs/assets/copy
- No dark-pattern or deceptive-UX generators

Have an idea? [Open a Discussion](https://github.com/cognis-digital/syntheon/discussions) or a
[good first issue](https://github.com/cognis-digital/syntheon/issues).
